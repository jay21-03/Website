...
export function SiteHeader({ account, phone }: { account: import('react').ReactNode; phone?: string }) {
    ...
    >
      ...
      <div
        className={cn(
          ...
          open ? "translate-y-0 opacity-100" : "invisible pointer-events-none -translate-y-2 opacity-0",
        )}
      >
